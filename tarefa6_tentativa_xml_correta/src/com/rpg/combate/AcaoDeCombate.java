// src/com/rpg/combate/AcaoDeCombate.java
 ...
 */
// JAXB: Indica que AcaoDeCombate pode ter várias subclasses concretas
@XmlSeeAlso({AtaqueArco.class, AtaqueAssombrado.class, AtaqueEspada.class,
        AtaqueGoblin.class, AtaqueVampirico.class, FlechaMagica.class, GolpeSagrado.class})

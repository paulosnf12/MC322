...
package com.rpg.cenario; // Declaração do pacote, conforme a nova estrutura

import com.rpg.game.Dificuldade;
import com.rpg.itens.ArcoAlpha;
import com.rpg.itens.ArcoBeta; // Importa o enum de Dificuldade
...
public class ConstrutorDeCenarioFixo implements GeradorDeFases {
    ...
    public List<Fase> gerar(int nFases, Dificuldade dificuldade) { // <-- MUDANÇA AQUI: Adicionado Dificuldade
        ...
        for (int i = 0; i < nFases; i++) {
            ...
            // Criar algumas armas para os monstros largarem, usando as novas classes
            // concretas de Arma
            ...
            for (int j = 0; j < nivelFase + 2; j++) { // Usa nivelFase para determinar a quantidade de monstros
                ...
                // Variáveis para calcular atributos base e aplicar multiplicadores da dificuldade
                int vidaBaseMonstro;
                ...
                if (j % 3 == 0) {
                    ...
                    // Aplica os multiplicadores de dificuldade à vida, força e XP dos monstros
                    ...
                    monstrosFase.add(new Goblin(
                        ...
                        vidaBaseMonstro, // Mais vida com multiplicador de dificuldade
                        forcaBaseMonstro, // Mais força com multiplicador de dificuldade
                        nivelFase * 2 + 8, // Mais agilidade (antes nivelFase + 6)
                        xpBaseMonstro, // Mais XP com multiplicador de dificuldade
                        "Adaga",
                        3 + nivelFase,
                        0.2 + (nivelFase * 0.05),
